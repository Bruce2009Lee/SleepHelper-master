...
public class ActivityViewPagerDemoSec extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewpager_sec);
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (position == 0) {
                    viewPager.setCurrentItem(mMyAdapter.getCount() - 2, false);
                }
