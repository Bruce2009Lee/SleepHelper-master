...
public class ActivityBannerMain extends AppCompatActivity implements OnItemClickListener {
    ...
    private void initView() {
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, String data) {
                Toast.makeText(ActivityBannerMain.this, data, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onItemClick(int position) {
        Toast.makeText(ActivityBannerMain.this, "Banner:"+position, Toast.LENGTH_SHORT).show();
    }
